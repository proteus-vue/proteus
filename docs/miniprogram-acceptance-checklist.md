...
**环境**：微信开发者工具 2.02.2609082 Nightly（`/Volumes/data1/applications/wechatwebdevtools.app`）·
已登录（appid `wx33bc04a52024def7`）· 渲染模式 **Skyline** · 模拟器 iPhone 12/13 Pro。

> ★★**本机 wechatide 已确认可用**（2026-09-14）：skill-CLI 二进制在
> **`/Volumes/data1/applications/wechatwebdevtools.app/Contents/MacOS/wechatide`**
