...
- **文档版本**：v3.8（宿主层三 plan 追加：G-41/G-42/G-43）
- **规约文档数**：18 份原始 plan（G-01~G-20）+ 15 份新增 plan（G-21~G-35 追加）+ 8 份 SPI/Agent plan（G-36~G-43 追加）+ 本规约 + 1 份原则补充（design-principle）
