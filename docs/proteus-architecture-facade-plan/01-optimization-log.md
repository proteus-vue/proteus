...
| v3.18 | G-60 studio-website-landing 追加 | **G-60**（studio-website-landing，Studio 官网落地与插件 API 文档——**第 23 次泛化：不绑文档形态**；文档即契约红线 + 漂移阻断 + 数字不粉饰官网专项 + 私钥不可逆风险管控，决策 #397）；编号避让：原稿自编 G-61 → 定案 G-60 + CMP-215~235→207~227（三段式 INV/AP/接缝全入 CMP）+ 原则 #13.60-63→#13.80-83（**第六次撞号**）+ 泛化"第 19 次"→第 23 次；原则 #13.80-83、铁律 G-60.1-9、规则 CMP207-227 并入 L0 规约；spi-first 映射表登记第 23 次 | 规约表 G-01~G-60 · 编号避让 + 四路登记同步 |
| v3.17 | G-59 plugin-ecosystem 追加 | **G-59**（plugin-ecosystem，插件生态治理与性能契约——**第 22 次泛化：不绑生态治理模式，首个治理形态轴**；激活契约 + 数据敏感度分级 + 信任不可继承 + 破坏率看板，决策 #396）；编号避让：原稿自编 G-60 → 定案 G-59 + CMP-203~214→195~206 + 原则 #13.60-64→#13.75-79（**第五次撞号**）+ 泛化"第 19 次"→第 22 次；原则 #13.75-79、铁律 G-59.1-9、规则 CMP195-206 并入 L0 规约；spi-first 映射表登记第 22 次 | 规约表 G-01~G-59 · 编号避让 + 四路登记同步 |
| v3.16 | G-58 plugin-api 追加 | **G-58**（plugin-api，Proteus Studio 插件 API 与扩展生态——**第 21 次泛化：不绑扩展来源**；内置功能走 API 红线 + 零权限 + 声明式优先 + WIT 版本化 + WASM 隔离，决策 #395）；编号避让：原稿自编 G-59（studio 预留号）→ 定案 G-58 + CMP-195~202→187~194 + 原则 #13.60-62→#13.72-74（**第四次撞号**）+ 泛化"第 18 次"→第 21 次；原则 #13.72-74、铁律 G-58.1-8、规则 CMP187-194 并入 L0 规约；spi-first 映射表登记第 21 次 | 规约表 G-01~G-58 · 编号避让 + 四路登记同步 |
| v3.15 | G-57 inspector 追加 | **G-57**（inspector，Proteus Inspector 三层可观测性叠加——**第 20 次泛化：不绑可观测性来源**；叠加不替代 + L1 语义增强 + 扩展协议 + 安全红线，决策 #394）；编号避让：原稿自编 G-58 → 定案 G-57 + CMP-187~194→179~186 + 原则 #13.60-62→#13.69-71（第三次撞号）+ 泛化"第 17 次"→第 20 次；原则 #13.69-71、铁律 G-57.1-8、规则 CMP179-186 并入 L0 规约；spi-first 映射表登记第 20 次 | 规约表 G-01~G-57 · 编号避让 + 四路登记同步 |
| v3.14 | G-56 studio 追加 | **G-56**（studio，Proteus Studio 自有宿主壳——**第 19 次泛化：不绑宿主来源**；绝不自研编辑器/GUI 红线 + 四宿主共用内核零改动 + 移动端伴侣 + 生态边界诚实，决策 #393）；编号避让：原稿自编 G-57 → 定案 G-56 + CMP-179~186→171~178 + 原则 #13.57-59→#13.66-68（与 G-53 撞号）+ 泛化"第 16 次"→第 19 次 + G-59 预留取消；原则 #13.66-68、铁律 G-56.1-9、规则 CMP171-178 并入 L0 规约；spi-first 映射表登记第 19 次 | 规约表 G-01~G-56 · 编号避让 + 四路登记同步 |
| v3.13 | G-55 devtools-landing 追加 | **G-55**（devtools-landing，开发者工具落地形态与性能工程——G-54 的工程落地**不占泛化序**，沿 G-37→G-27 先例；宿主适配绝不 fork + Rust 常驻内核 + 确定性性能预算 + 架构试金石 INV-PF-06，决策 #392）；编号避让：原稿自编 G-56 → 定案 G-55 + CMP-171~178→163~170 + 原则 #13.60-62→#13.63-65（与 G-54 原稿撞号）+ 泛化"第 16 次"修正；原则 #13.63-65、铁律 G-55.1-8、规则 CMP163-170 并入 L0 规约 | 规约表 G-01~G-55 · 编号避让 + 四路登记同步 |
| v3.12 | G-53 补登记 + G-54 追加 | **G-53**（mobile-verification，移动端验证编排，第十七次投影：不绑设备供给方式——#390ii 批次顺带入库未登记，本批补登记 + 泛化序修正 15→17）+ **G-54**（devtools-suite，框架配套开发者工具·编码期，第十八次投影：不绑 IDE 形态——原稿自编 G-55 编号避让重编 G-54、CMP-163~170→155~162、假想「DevTools 加固」降级为未编号规划，决策 #391）；原则 #13.57-62、铁律 G-53.1-8/G-54.1-8、规则 CMP147-154/CMP155-162 并入 L0 规约；spi-first 映射表登记第 17~18 次泛化 | 规约表 G-01~G-54 · 两 plan 四路登记同步 |
...
| G-53 | mobile-verification（移动端验证编排：SimulatorBackend 四档 + CoverageGate） | G-51,G-52 | 设备供给插头（不绑设备供给方式；CMP147-154，#390ii 顺带入库 / #391 补登记） |
| G-54 | devtools-suite（框架配套开发者工具·编码期：能力内核唯一 + 五档适配） | G-19,G-50,G-51,G-53 | 编码期插头（不绑 IDE 形态；原稿 G-55 编号避让重编；CMP155-162，决策 #391） |
| G-55 | devtools-landing（开发者工具落地形态与性能工程：不 fork + 常驻内核 + 确定性预算） | G-54,G-51,G-53,G-27 | G-54 工程落地（不占泛化序；原稿 G-56 编号避让重编；CMP163-170，决策 #392） |
| G-56 | studio（自有宿主壳：StudioShell/EmbedStrategy/CompanionLink + 移动端伴侣） | G-55,G-54,G-53 | 第 19 次泛化（不绑宿主来源；原稿 G-57 编号避让重编；CMP171-178，决策 #393） |
| G-57 | inspector（三层可观测性叠加：出口协议化 + 语义叠加） | G-19,G-51,G-54,G-56 | 第 20 次泛化（不绑可观测性来源；原稿 G-58 编号避让重编；CMP179-186，决策 #394） |
| G-58 | plugin-api（插件 API 与扩展生态：PluginHost + 零权限 + WIT 版本化） | G-56,G-55,G-54,G-51 | 第 21 次泛化（不绑扩展来源；原稿 G-59 编号避让重编；CMP187-194，决策 #395） |
| G-59 | plugin-ecosystem（生态治理与性能契约：激活契约 + 数据分级 + 信任不可继承） | G-58,G-55,G-37 | 第 22 次泛化（不绑生态治理模式，首个治理轴；原稿 G-60 编号避让重编；CMP195-206，决策 #396） |
| G-60 | studio-website-landing（官网落地：WIT 生成参考页 + 漂移阻断 + 下载签名） | G-56,G-58,G-59 | 第 23 次泛化（不绑文档形态；原稿 G-61 编号避让重编；CMP207-227，决策 #397） |
