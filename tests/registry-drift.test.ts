...
/** 规则 ID 字面量模式：phase/name（与 transforms/types.ts 的 id 规范一致；component/ 为 2026-08 组件 class 透传决策域） */
const ID_RE = /'((?:tag|event|directive|nav|node|annotation|template|script|style|validate|slot|transition|component)\/[a-z0-9-]+)'/g
