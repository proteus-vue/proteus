...
|---|---|---|
| ui.select | Content & Forms | `<picker>` (L1 primitive) · `<selection>` (L1 primitive) |
...
| WeChat Mini Program | ✅ | skyline (WebView fallback) · native control mapping → `<picker>` (L1 primitive) · `<selection>` (L1 primitive) |
...
<!-- generated by website/scripts/gen-content.mjs (en overlay) · source SSOT: packages/components/p-select/index.vue -->