...
| `frontColor` | — | `String` | `'#000000'` | No |
| `backgroundColor` | — | `String` | `'#ffffff'` | No |
| `colorAnimationDuration` | — | `Number` | `0` | No |
| `colorAnimationTimingFunc` | — | `String` | `'linear'` | No |
...
- **Type**: `String`　**Default**: `'#000000'`　**Required**: No
- **Doc**: —
...
- **Type**: `String`　**Default**: `'linear'`　**Required**: No
- **Doc**: —
...
<!-- generated by website/scripts/gen-content.mjs (en overlay) · source SSOT: packages/components/p-nav-bar/index.vue -->