...
|---|---|---|---|---|
| `name` | Icon name (built-in glyph table; unknown → '?') | `String` | `''` | No |
| `type` | — | `String` | `''` | No |
...
<!-- generated by website/scripts/gen-content.mjs (en overlay) · source SSOT: packages/components/p-icon/index.vue -->