...
| `zIndex` | — | `Number` | `2000` | No |
| `closeOnSlideDown` | — | `Boolean` | `false` | No |
| `overlayStyle` | — | `String` | `''` | No |
| `customStyle` | — | `String` | `''` | No |
...
<!-- generated by website/scripts/gen-content.mjs (en overlay) · source SSOT: packages/components/p-page-container/index.vue -->