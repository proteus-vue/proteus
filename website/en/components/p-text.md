...
| `overflow` | — | `String` | `''` | No |
| `maxLines` | — | `Number` | `0` | No |
| `selectOnGesture` | — | `Boolean` | `false` | No |
| `space` | — | `String` | `''` | No |
| `decode` | — | `Boolean` | `false` | No |
...
<!-- generated by website/scripts/gen-content.mjs (en overlay) · source SSOT: packages/components/p-text/index.vue -->