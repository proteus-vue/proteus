...
|---|---|---|---|
| Platform API (G-31/32) | p-* semantic components + the 142-primitive SSOT + 53 Capability Hooks | Per-target semantic implementations; the Mini Program component set = the Layer 1 compatibility layer | ✅ |
