...
|---|---|---|---|
| Platform API (G-31/32) | p-* semantic components + the 153-primitive SSOT + 64 Capability Hooks | Per-target semantic implementations; the Mini Program component set = the Layer 1 compatibility layer | ✅ |
