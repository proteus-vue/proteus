...
|---|---|---|---|
| Platform API (G-31/32) | p-* semantic components + the 164-primitive SSOT + 75 Capability Hooks | Per-target semantic implementations; the Mini Program component set = the Layer 1 compatibility layer | ✅ |
