...
|---|---|---|---|
| Platform API (G-31/32) | p-* semantic components + the 176-primitive SSOT + 81 Capability Hooks | Per-target semantic implementations; the Mini Program component set = the Layer 1 compatibility layer | ✅ |
