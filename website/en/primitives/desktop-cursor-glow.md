...
Pointer-following ambient glow (brand purple/cyan dual blooms, lerp-interpolated trail)
...
## Core exports (SSOT: `packages/desktop/src/cursor-glow.ts`)

| Export | Kind | One-liner (source comment) |
|---|---|---|
| `CursorGlowOptions` | interface | — |
| `CursorGlowHandle` | interface | — |
| `CURSOR_GLOW_DEFAULTS` | const | Defaults (Proteus design-tokens: brand purple / brand2 cyan) |
