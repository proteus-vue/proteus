...
完整验证体系见[一致性验证](/docs/26-conformance)。

## 下一步

- [渲染后端](/docs/04-render-backend)：RenderBackend SPI、五官方后端与混合渲染
- [编译管线](/docs/20-compiler-pipeline)：规则注册表、决策 trace 与产物自校验
- [一致性验证](/docs/26-conformance)：conformance 套件与 CI 门禁
