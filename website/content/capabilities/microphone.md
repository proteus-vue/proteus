...
useMicrophone：麦克风访问（wx.authorize / web getUserMedia）
...
| code | 说明 |
|---|---|
| `microphone.unsupported` | 桥未提供 getMicrophone（useMicrophone 不可用） |
...
| 微信小程序 | ✅ | skyline（WebView 降级） · wx 桥 → RecorderManager |
