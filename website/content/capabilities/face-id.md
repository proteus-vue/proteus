...
useFaceID：人脸识别认证（wx startSoterAuthentication facial / web WebAuthn）
...
| 参数 | 类型 | 必填 | 说明 |
|---|---|---|---|
| `prompt` | `string` | 否 | 认证提示文案（原生系统 UI 展示） |
...
| code | 说明 |
|---|---|
| `face-id.unsupported` | 桥未提供 authenticateFaceID（useFaceID 不可用） |
