...
| 属性 | 说明 | 类型 | 默认值 | 必填 |
|---|---|---|---|---|
| `label` | 无障碍标签 / 默认按钮文案 | `String` | `'扫码'` | 否 |
...
```vue
<p-scan-qr :label="'扫码'" :auto="true">
  <p-text>内容</p-text>
</p-scan-qr>
```

<!-- generated by website/scripts/gen-content.mjs · 源码 SSOT：packages/components/p-scan-qr/index.vue -->