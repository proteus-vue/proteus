...
```vue
<p-input :disabled="true" :value="'…'" :type="'text'">
  <p-text>内容</p-text>
</p-input>
```

<!-- generated by website/scripts/gen-content.mjs · 源码 SSOT：packages/components/p-input/index.vue -->