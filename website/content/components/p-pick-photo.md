...
```vue
<p-pick-photo :label="'选择图片'" :auto="true">
  <p-text>内容</p-text>
</p-pick-photo>
```

<!-- generated by website/scripts/gen-content.mjs · 源码 SSOT：packages/components/p-pick-photo/index.vue -->