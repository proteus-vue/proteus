...
```vue
<p-spacer :grow="1" :shrink="1" :minSize="1">
  <p-text>内容</p-text>
</p-spacer>
```

<!-- generated by website/scripts/gen-content.mjs · 源码 SSOT：packages/components/p-spacer/index.vue -->