...
| `lines` | 行数（骨架屏占位行数） | `Array` | `() => [90, 70, 80]` | 否 |
...
```vue
<p-skeleton :disabled="true" :avatar="true">
  <p-text>内容</p-text>
</p-skeleton>
```

<!-- generated by website/scripts/gen-content.mjs · 源码 SSOT：packages/components/p-skeleton/index.vue -->