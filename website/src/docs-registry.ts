...
const EN_DIR_BY_BASE: Record<string, string> = { '/docs': 'guides', '/docs/framework': 'framework', '/docs/component': 'components', '/docs/capability': 'capabilities', '/docs/system': 'system', '/docs/plugin': 'plugins' }
