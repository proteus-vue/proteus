...
const scenariosZh = [
  ...
  { icon: 'box', title: '设计系统与组件库', desc: '170 语义原语 SSOT 驱动 66 个语义组件 + 设计 token；布局语义编译期可校验，而非 CSS 事后救。' },
]
const scenariosEn = [
  ...
  { icon: 'box', title: 'Design systems & libraries', desc: '170 semantic primitives SSOT drive 66 semantic components + design tokens; layout semantics checked at compile time, not patched with CSS.' },
]
...
const capabilitiesZh = [
  ...
  },
  {
    tag: 'G-31/32',
    title: '语义原语 SSOT',
    desc: '170 语义原语单一事实源 → 66 个语义组件 → 48 implemented 语义 × 6 后端 conformance 门禁 + 81 Capability Hook。',
  },
  {
    tag: 'G-41/42/43',
    title: '宿主层三件套',
...
const capabilitiesEn = [
  ...
  { tag: 'G-31/32', title: 'Semantic primitives SSOT', desc: '170 semantic primitives SSOT → 66 semantic components → 48 implemented semantics × 6 backends under conformance gates + 81 capability Hooks.' },
...
const STATS_EN = [
  ...
  { value: '170', label: 'semantic primitives SSOT', source: 'PRIMITIVE_CATALOG (proteus audit coverage)' },
