...
const zh = {
  ...
  'home.mdEyebrow': '多端同屏',
  'home.mdTitle': '同一份源码，六种终端，各自原生呈现',
  'home.mdSub': '切一下设备，变的不是你的代码——是渲染决策。手机 / 平板 / PC / 车机 / TV / 手表，全部实时可玩。',
  'home.mdCta': '进入多端同屏',
...
const en = {
  ...
  'home.mdEyebrow': 'Multi-device',
  'home.mdTitle': 'One source. Six form factors. Each renders natively.',
  'home.mdSub': 'Switch the device — your code never changes, only the render decision. Phone / tablet / PC / in-car / TV / watch, all playable live.',
  'home.mdCta': 'Open multi-device demo',
