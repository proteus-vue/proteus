...
//   package.json / proteus.config.ts / tsconfig.json / src/main* / src/App.vue /
//   src/pages/ / src/router/auto-routes.ts
// ★#418 配置收敛：vite.config.ts / scripts/gen-routes.ts / scripts/mp-entry-stub.ts 已删除——
//   vite 配置由 @proteus-vue/plugin-vite resolveProteusViteConfig 框架组装，gen-routes/mp 入口由 CLI 内建
