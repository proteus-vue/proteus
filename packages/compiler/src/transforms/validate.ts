...
export const VALIDATE_RULES: TransformRule[] = [
  ...
  },
  {
    ...
    example: { before: '// 产物含 wx:key="{{x}}" / class 双属性 / <PModal> / {{ a?.b }} / wx:else 悬挂 / wx:key 无 wx:for', after: 'CompilerError: [proteus-compiler] xxx.vue: wxml 产物平台标准违规：[DataBindingNotAllowed/InvalidAttribute/…] …' },
    verify: 'tests/compiler-validate-wxml-platform.test.ts（wxml 平台六检查）',
