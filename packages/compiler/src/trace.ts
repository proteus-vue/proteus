...
//   @proteus/types/compiler-types（本文件保留 runtime 函数 createTrace/lineAt + re-export）
import type { TransformPhase, TransformTrace, TransformTraceEvent } from '@proteus/types/compiler-types'

export type { TransformTraceEvent, TransformTrace } from '@proteus/types/compiler-types'
