...
- Updated dependencies
  - @proteus-vue/built-in-components@0.3.0-beta.12

## 0.3.0-beta.11

### Patch Changes

- @proteus-vue/built-in-components@0.3.0-beta.11

## 0.3.0-beta.10

### Patch Changes

- @proteus-vue/built-in-components@0.3.0-beta.10

## 0.3.0-beta.9

### Patch Changes

- @proteus-vue/built-in-components@0.3.0-beta.9
...
- Updated dependencies
  - @proteus-vue/built-in-components@0.3.0-beta.8
...
- Updated dependencies
  - @proteus-vue/built-in-components@0.3.0-beta.7
...
- 发布同步：有状态单例挂 globalThis（修「包副本分裂 → 静默失效」）+ Web 路由表/路由参数
  ...
  **★ 为何 `api` / `capabilities` / `devtools` / `web` / `worklet` 也在内**（源码未改但须重发）：
  ...
  - @proteus-vue/built-in-components@0.1.1-beta.4

## 0.1.1-beta.3

### Patch Changes

- @proteus-vue/built-in-components@0.1.1-beta.3
...
- 发布同步：修复「同版本号、内容不同」的发布漂移
  ...
  - @proteus-vue/built-in-components@0.1.1-beta.2

## 0.1.1-beta.1

### Patch Changes

- @proteus-vue/built-in-components@0.1.1-beta.1
...
- Updated dependencies
  - @proteus-vue/built-in-components@0.1.1-beta.0
